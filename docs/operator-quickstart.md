# Operator Quickstart — Support Activities For Crop Production Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0161** (`cloud-itonami-isic-0161`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0161.git
cd cloud-itonami-isic-0161
```
...
- Blueprint governor key: `cropsupport-governor`
- Likely source path: `cropsupport.governor.cljc`
