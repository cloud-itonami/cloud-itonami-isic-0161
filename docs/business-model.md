# Business Model: Support Activities For Crop Production Coordination
...
## Classification
- Repository: `cloud-itonami-isic-0161` ([github.com/cloud-itonami/cloud-itonami-isic-0161](https://github.com/cloud-itonami/cloud-itonami-isic-0161))
- ISIC Rev.5: `0161` — Support Activities For Crop Production Coordination
- Domain: `:agriculture/crop-support-services`
- Social impact: :food-security :farm-labor-efficiency :pesticide-safety
- Actor: `:cropsupport-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :agriculture/crop-support-services — who wants
...
One managed tenant (:agriculture/crop-support-services):
...
- Do not bypass the `:cropsupport-governor` for production decisions.
